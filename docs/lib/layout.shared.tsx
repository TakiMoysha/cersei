...
const AtlasIcon = (
  ...
  <img
    ...
    width={24}
    height={14}
    style={{ width: 'auto', height: '0.875rem', display: 'block' }}
  />
);
    ...
    links: [
      {
        ...
        text: 'Discord',
        label: 'Cersei community on Discord',
        icon: DiscordIcon,
        external: true,
        secondary: true,
      },
      {
        ...
        text: 'Atlas',
        label: 'Atlas — Cersei is part of the Atlas project',
        icon: AtlasIcon,
        external: true,
        secondary: true,
      },
